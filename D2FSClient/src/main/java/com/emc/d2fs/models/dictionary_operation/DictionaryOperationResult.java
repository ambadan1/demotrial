...
/**
 * <p>Java class for dictionary_operation_result complex type.
 * 
...
@XmlType(name = "dictionary_operation_result", propOrder = {
    "operation",
    "value",
    "values",
    "success"
})
public class DictionaryOperationResult {

    protected DictionaryOperation operation;
