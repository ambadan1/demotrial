 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="same" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "setImportContentSameRequest")
public class SetImportContentSameRequest {

    @XmlElement(namespace = "http://www.emc.com/d2fs/models/context", required = true)
    protected Context context;
    @XmlAttribute(name = "same", required = true)
