 ...
 *         &lt;element name="searchTypes" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlRootElement(name = "getSearchAssistanceValuesRequest")
public class GetSearchAssistanceValuesRequest {

    @XmlElement(namespace = "http://www.emc.com/d2fs/models/context", required = true)
    protected Context context;
    protected List<String> searchTypes;
     ...
     * This is why there is not a <CODE>set</CODE> method for the searchTypes property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSearchTypes().add(newItem);
     * </pre>
     * 
     * 
     * <p>
