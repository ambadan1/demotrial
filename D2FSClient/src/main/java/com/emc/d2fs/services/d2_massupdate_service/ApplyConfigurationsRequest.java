 ...
 *         &lt;element name="objectIds" type="{http://www.w3.org/2001/XMLSchema}string" maxOccurs="unbounded"/&gt;
 *         &lt;element ref="{http://www.emc.com/d2fs/models/attribute}attributes" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "applyConfigurationsRequest")
public class ApplyConfigurationsRequest {

    @XmlElement(namespace = "http://www.emc.com/d2fs/models/context", required = true)
    protected Context context;
    @XmlElement(required = true)
    protected List<String> objectIds;
    @XmlElement(namespace = "http://www.emc.com/d2fs/models/attribute", required = true)
