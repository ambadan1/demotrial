 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="space" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
...
@XmlRootElement(name = "getIsWidgetInViewRequest")
public class GetIsWidgetInViewRequest {

    @XmlElement(namespace = "http://www.emc.com/d2fs/models/context", required = true)
    protected Context context;
    @XmlAttribute(name = "space", required = true)
    protected String space;
    @XmlAttribute(name = "widget", required = true)
