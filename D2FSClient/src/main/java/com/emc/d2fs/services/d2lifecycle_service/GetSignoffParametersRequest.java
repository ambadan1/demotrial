 ...
 *       &lt;attribute name="targetState" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "getSignoffParametersRequest")
public class GetSignoffParametersRequest {
    ...
    protected String id;
    @XmlAttribute(name = "targetState", required = true)
