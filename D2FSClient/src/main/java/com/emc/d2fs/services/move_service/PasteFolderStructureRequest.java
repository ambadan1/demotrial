 ...
 *         &lt;element name="sourceContext" type="{http://www.emc.com/d2fs/models/context}context"/&gt;
 *         &lt;element ref="{http://www.emc.com/d2fs/models/attribute}attributes" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;attribute name="masterId" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
...
@XmlRootElement(name = "pasteFolderStructureRequest")
public class PasteFolderStructureRequest {
     ...
     *     
     */
    public void setSourceContext(Context value) {
