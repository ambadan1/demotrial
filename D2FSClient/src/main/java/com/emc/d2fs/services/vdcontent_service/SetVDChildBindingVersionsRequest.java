 ...
 *       &lt;attribute name="childIdx" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *       &lt;attribute name="versionLabel" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "setVDChildBindingVersionsRequest")
public class SetVDChildBindingVersionsRequest {
    ...
    protected String childIdx;
    @XmlAttribute(name = "versionLabel", required = true)
     ...
     *     
     */
    public void setChildIdx(String value) {
        this.childIdx = value;
    }
