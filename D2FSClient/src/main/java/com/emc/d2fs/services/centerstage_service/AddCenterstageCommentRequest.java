 ...
 *         &lt;element name="comment" type="{http://www.emc.com/d2fs/models/comment}comment"/&gt;
 *       &lt;/sequence&gt;
...
@XmlRootElement(name = "addCenterstageCommentRequest")
public class AddCenterstageCommentRequest {
