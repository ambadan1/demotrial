 ...
 *       &lt;attribute name="dialogName" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "getSubformInfoRequest")
public class GetSubformInfoRequest {
    ...
    protected String id;
    @XmlAttribute(name = "dialogName", required = true)
    ...
    /**
     * Gets the value of the dialogName property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the dialogName property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
