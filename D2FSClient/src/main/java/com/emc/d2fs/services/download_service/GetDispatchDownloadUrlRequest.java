 ...
 *       &lt;attribute name="viewNative" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" /&gt;
...
@XmlRootElement(name = "getDispatchDownloadUrlRequest")
public class GetDispatchDownloadUrlRequest {
    ...
    @XmlAttribute(name = "viewNative", required = true)
    protected boolean viewNative;
     ...
     * 
     */
    public boolean isViewNative() {
        return viewNative;
    }

    /**
     * Sets the value of the viewNative property.
     * 
     */
    public void setViewNative(boolean value) {
        this.viewNative = value;
    }
