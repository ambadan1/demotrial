 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="restore" use="required" type="{http://www.w3.org/2001/XMLSchema}boolean" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "setWorkspaceRestoreRequest")
public class SetWorkspaceRestoreRequest {

    @XmlElement(namespace = "http://www.emc.com/d2fs/models/context", required = true)
    protected Context context;
    @XmlAttribute(name = "restore", required = true)
